    ...
    App.register('email', {
      render: function(container) {
        ...
        var agentHtml = '<div id="email-agent-section" style="background:#fff;border:2px solid #1a5276;border-radius:10px;padding:20px;margin:0 12px 16px;">'
          ...
          + '<button onclick="if(confirm(\'Limpar TODAS as tags de todos os emails?\')){window.outlookLimparTodasTags()}" style="background:#888;color:#fff;border:none;padding:10px 12px;border-radius:6px;font-weight:600;font-size:11px;cursor:pointer">🗑 Limpar Tags</button></div>'
